...
if __name__ == '__main__':
    ...
    interprete4 = Interprete(nombre="Arturo Sandoval", texto_curiosidades="No sabía quién era")
    ...
    # Crear álbumes
    album1 = Album(titulo="Latin Jazz Compilation", ano=2021, descripcion="Álbum original", medio=Medio.DISCO)
    ...
    # Relacionar álbumes con canciones
